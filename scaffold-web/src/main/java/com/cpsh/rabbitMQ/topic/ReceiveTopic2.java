...
public class ReceiveTopic2 {
    ...
    private static final String TOPIC_QUEUE = "topic_queue2";
    ...
    public static void main(String[] argv) throws Exception {
        ...
        for (String bindingKey : routingKeys) {
            ...
            System.out.println("ReceiveTopic2 exchange:" + EXCHANGE_NAME
                    + ", queue:" + TOPIC_QUEUE + ", BindRoutingKey:"
                    + bindingKey);
        }

        System.out
                .println("ReceiveTopic2 [*] Waiting for messages. To exit press CTRL+C");
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
                ...
                System.out.println("ReceiveTopic2 [x] Received '"
