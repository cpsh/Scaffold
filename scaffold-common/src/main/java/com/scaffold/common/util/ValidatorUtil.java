...
//    public static final String REGEX_PASSWORD = "^[a-zA-Z0-9]{6,16}$";
     ...
     * 正则表达式：验证电话 - 带区号
     */
    public static final String REGEX_TELEPHONE_WITH_CODE = "^[0][1-9]{2,3}-[0-9]{5,10}$";

    /**
     * 正则表达式：验证电话 - 不带区号
     */
    public static final String REGEX_TELEPHONE_NO_CODE = "^[1-9]{1}[0-9]{5,8}$";
...
*/
    ...
    public static boolean isTelePhone(String tel) {
        boolean b = false;
        if(tel.length() >9){
            b = Pattern.matches(REGEX_TELEPHONE_WITH_CODE,tel); // 验证带区号的
        }else{
            b =  Pattern.matches(REGEX_TELEPHONE_NO_CODE,tel); // 验证没有区号的
        }
        return b;
    }
